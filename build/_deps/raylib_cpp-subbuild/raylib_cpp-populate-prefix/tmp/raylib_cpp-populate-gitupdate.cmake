...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v4.5.1"
  WORKING_DIRECTORY "D:/cs163/Overcooked---A-Game-Project-for-CS202/build/_deps/raylib_cpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v4.5.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v4.5.1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/cs163/Overcooked---A-Game-Project-for-CS202/build/_deps/raylib_cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/cs163/Overcooked---A-Game-Project-for-CS202/build/_deps/raylib_cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
